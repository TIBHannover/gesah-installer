...
<script type="text/javascript" src="${urls.base}/themes/gesah/js/nouislider.min.js"></script>
<script type="text/javascript" src="${urls.base}/themes/gesah/js/wNumb.min.js"></script>
