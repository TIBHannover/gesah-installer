...
<div class="container">
	<div class="row">
		<div class="col-md-12">
<h1 class="vivo-logo" style="background:url(${urls.base}/images/${i18n().header_logo_file_name}) 0 0 no-repeat;"><a title="${i18n().identity_title}" href="${urls.home}"><span class="displace">${siteName}</span></a></h1>
