...
<#if isEdit>
  <div class="partObjectCreation" style="display:none;" >
    <input form="part-creation" type="checkbox" name="depicts-${statement.uri("object")}" value="${statement.uri("object")}">
    <label style="display:inline;" for="depicts-${statement.uri("object")}">Use depicts</label>
  </div>
</#if>
