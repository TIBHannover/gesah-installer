...
<#-- Template for property listing on individual profile page -->
        ...
        <#list group.properties as property>
            ...
            <article class="property" role="article">
				...
				<#elseif rangeClass == "ResearcherRole" && !individual.editable>
					<h3 id="${property.localName}-${rangeClass}" title="${property.publicDescription!}">${property.name} <@p.addLink property editable /> <@p.verboseDisplay property /> </h3>
				<#elseif property.localName == "has_digital_representation" || property.localName == "has_part">
					<h3 id="${property.localName}" title="${property.publicDescription!}">${property.name} <@p.addLink property editable /> <@p.addToggle property.localName /> <@p.verboseDisplay property /> </h3>
				<#else>
