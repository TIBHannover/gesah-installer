...
<#if isEdit>
  <div class="partObjectCreation" style="display:none;" >
    <input form="part-creation" type="checkbox" name="narrower_term-${statement.uri("object")}" value="${statement.uri("object")}" checked>
    <label style="display:inline;" for="narrower_term-${statement.uri("object")}">Use narrower term</label>
  </div>
</#if>