...
<#macro showStatement statement property datatype>
	...
	<#if isEdit>
	  <div class="partObjectCreation" style="display:none;" >
	    <input form="part-creation" type="checkbox" name="secondary-literature" value="${theValue?html}">
	    <label style="display:inline;" for="secondary-literature">Use secondary literature</label>
	  </div>
	</#if>
</#macro>
