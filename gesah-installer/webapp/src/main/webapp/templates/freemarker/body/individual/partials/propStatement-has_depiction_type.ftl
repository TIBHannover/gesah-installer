...
<#if isEdit>
  <div class="partObjectCreation" style="display:none;" >
    <input form="part-creation" type="checkbox" name="depiction-type-${statement.uri("object")}" value="${statement.uri("object")}">
    <label style="display:inline;" for="depiction-type-${statement.uri("object")}">Use depiction type</label>
  </div>
</#if>