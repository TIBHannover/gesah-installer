...
<#if isEdit>
  <div class="partObjectCreation" style="display:none;" >
    <input form="part-creation" type="checkbox" name="generic_term-${statement.uri("object")}" value="${statement.uri("object")}" checked>
    <label style="display:inline;" for="generic_term-${statement.uri("object")}">Use generic term</label>
  </div>
</#if>