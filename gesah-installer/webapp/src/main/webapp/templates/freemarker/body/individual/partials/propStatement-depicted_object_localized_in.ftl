...
<#if isEdit>
  <div class="partObjectCreation" style="display:none;" >
    <input form="part-creation" type="checkbox" name="depicted-object-localized-in-${statement.uri("object")}" value="${statement.uri("object")}">
    <label style="display:inline;" for="depicted-object-localized-in-${statement.uri("object")}">Use depicted object localized in</label>
  </div>
</#if>
