...
<#if isEdit>
  <div class="partObjectCreation" style="display:none;" >
    <input form="part-creation" type="checkbox" name="geographic_assignment-${statement.uri("object")}" value="${statement.uri("object")}" checked>
    <label style="display:inline;" for="geographic_assignment-${statement.uri("object")}">Use georgraphic assignment</label>
  </div>
</#if>