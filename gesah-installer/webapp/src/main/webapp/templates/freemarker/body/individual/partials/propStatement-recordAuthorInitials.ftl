...
<#macro showStatement statement property datatype>
	...
	<#if isEdit>
	  <div class="partObjectCreation" style="display:none;" >
	    <input form="part-creation" type="checkbox" name="record-author-initials" value="${theValue?html}">
	    <label style="display:inline;" for="record-author-initials">Use indexed by</label>
	  </div>
	</#if>
</#macro>
