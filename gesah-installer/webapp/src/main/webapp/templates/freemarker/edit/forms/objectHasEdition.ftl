...
<#--
		<#if editMode == "edit" || editMode == "repair">
				<input type="hidden" id="newMaterialLabel_1" name="materialLabel" value=""/>
				<input type="hidden" id="materialLabel_1" name="existingMaterialLabel" value="${existingMaterialLabelValue!}"/>
		<#else>
